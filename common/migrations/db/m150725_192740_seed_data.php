...
class m150725_192740_seed_data extends Migration
{
    ...
    public function safeUp()
    {
        $this->insert('{{%user}}', [
            'id' => 1,
            'username' => 'minority',
            'email' => 'minorforyounot@gmail.com',
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('dfg6df54dfDD/$dx11Vfg'),
        ...
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('Drewfs@#vdfd34Adrw@fs9'),
            'auth_key' => Yii::$app->getSecurity()->generateRandomString(),
            'access_token' => Yii::$app->getSecurity()->generateRandomString(40),
            'status' => User::STATUS_ACTIVE,
            'created_at' => time(),
